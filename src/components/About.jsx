  ...
  return (
    <section className="px-20 py-20" id="about">
      ...
      <div className="flex xl:flex-row flex-col items-center justify-between gap-6 mt-5">
        ...
        <div className="w-full bg-white rounded-xl py-10 px-8 shadow-xl flex xl:flex-row flex-col justify-between gap-10">
          <p className="text-blue-900 xl:w-[50%] w-[100%] text-justify">Sou um desenvolvedor apaixonado por criar soluções inovadoras e eficientes. Com uma sólida formação
