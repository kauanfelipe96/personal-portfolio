      ...
      <div className="flex xl:flex-row flex-col items-center justify-between gap-6 mt-5">
        ...
        <Fade duration={2000} triggerOnce>
          <div className="dark:border-blue-500 dark:border dark:bg-slate-950 dark:text-slate-50 w-full bg-white rounded-xl py-10 px-8 shadow-xl flex xl:flex-row flex-col justify-between gap-10">
            <p className="dark:bg-slate-950 dark:text-slate-50 text-blue-900 xl:w-[50%] w-[100%] text-justify">Sou um desenvolvedor apaixonado por criar soluções inovadoras e eficientes. Cursando Análise e Desenvolvimento de Sistemas e com experiência prática em diversas empresas, estou comprometido em impulsionar o sucesso dos projetos em que me envolvo.</p>
