    ...
    work: [
      {
        ...
        bullets: [
          ...
          'Desenvolveu uma API de integração de pagamentos consumida por agências parceiras, com interface padronizada para processar pagamentos pela plataforma.',
    ...
    work: [
      {
        ...
        bullets: [
          ...
          'Built a complete restaurant management application for table reservations and activity scheduling, featuring a real-time kitchen dashboard powered by .NET SignalR.',
          ...
          "Handles cross-department service requests as N2 technical support and supervises and mentors the team's junior developer.",
        ],
        tags: ['.NET', 'SignalR', 'React', 'SQL Server', 'TOTVS', 'DDD', 'SOLID'],
      },
      {
